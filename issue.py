...
# Hardcoded credentials have been removed - use environment variables instead
...
class BadClass:
    def __init__(self):
        self.password = os.getenv("BADCLASS_PASSWORD", "default_password")
        self.token = os.getenv("BADCLASS_TOKEN", "default_token")
